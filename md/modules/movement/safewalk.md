...
└── Mode (Mode Selector | default: Safe | modes: None, Safe, OnEdge)
    └── [Mode: OnEdge]
        ├── Distance (Decimal Range | default: 0.1..0.15 | range: 0.05..0.5)
...
- **Distance** (Decimal Range) — default: `0.1` – `0.15`; range: `0.05` – `0.5` — How close to the block edge the player must be to trigger protection (randomized within the range).
...
---
*Last updated: 2026-06-08 — Based on [source code](https://github.com/CCBlueX/LiquidBounce/blob/2b0edfc/src%2Fmain%2Fkotlin%2Fnet%2Fccbluex%2Fliquidbounce%2Ffeatures%2Fmodule%2Fmodules%2Fmovement%2FModuleSafeWalk.kt)*
