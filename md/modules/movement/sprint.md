...
└── StopOn (Multi-Select | default: [Ground, Air, UsingItem] | options: Ground, Air, Sneaking, UsingItem)
```
...
- **StopOn** (Multi-Select) — default: `Ground`, `Air`, `UsingItem`; options: `Ground`, `Air`, `Sneaking`, `UsingItem` — Situations where sprinting should be stopped when not moving forward.
...
---
*Last updated: 2026-06-08 — Based on [source code](https://github.com/CCBlueX/LiquidBounce/blob/2b0edfc/src%2Fmain%2Fkotlin%2Fnet%2Fccbluex%2Fliquidbounce%2Ffeatures%2Fmodule%2Fmodules%2Fmovement%2FModuleSprint.kt)*
