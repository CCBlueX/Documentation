...
| SameY | Choice | Off | Off, On, JumpKey, Falling, Hypixel | Keeps placements on a single height level instead of stepping down. *JumpKey* holds the level while the jump key is released and steps down while you hold it. |
