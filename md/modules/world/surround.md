...
Builds holes that protect you from explosion damage.
...
```
├── Features (Multi-Select | default: [Extend, Down] | options: Center, Extend, NoWaste, Down)
├── DisableOn (Multi-Select | default: [YChange] | options: YChange, XZMove, XZSpeed)
├── Instant (Toggle | default: true)
├── AddExtraLayer (Key Bind)
├── Protect (Toggleable Group | default: on)
│   ├── Enabled (Toggle | default: true)
│   ├── MinDestroyProgress (Integer | default: 4 | range: 0..9 | stage)
│   └── ExtraLayer (Toggleable Group | default: on)
│       ├── Enabled (Toggle | default: true)
│       └── Corners (Toggle | default: false)
...
- **Enabled** (Toggle) — default: `true`
- **MinDestroyProgress** (Integer) — default: `4`; range: `0` – `9`; unit: stage
##### ExtraLayer
...
*Screenshots for Surround will be added in a future update.*

---
*Last updated: 2026-02-13 — Based on [source code](https://github.com/CCBlueX/LiquidBounce/blob/dfe60ac/src%2Fmain%2Fkotlin%2Fnet%2Fccbluex%2Fliquidbounce%2Ffeatures%2Fmodule%2Fmodules%2Fworld%2FModuleSurround.kt)*
