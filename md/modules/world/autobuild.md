...
Automatically builds certain structures.
...
```
├── Mode (Mode Selector | default: Portal | modes: Portal, Platform)
│   └── [Mode: Platform]
│       ├── DisableOnYChange (Toggle | default: true)
│       ├── Filter (Choice | default: WHITELIST | options: Whitelist, Blacklist)
│       ├── Blocks (Registry List)
│       └── Size (Integer | default: 3 | range: 1..6)
...
Select a mode for this feature. Available modes: **Portal**, **Platform**. Default: **Portal**.
...
*Screenshots for AutoBuild will be added in a future update.*

---
*Last updated: 2026-02-13 — Based on [source code](https://github.com/CCBlueX/LiquidBounce/blob/dfe60ac/src%2Fmain%2Fkotlin%2Fnet%2Fccbluex%2Fliquidbounce%2Ffeatures%2Fmodule%2Fmodules%2Fworld%2FModuleAutoBuild.kt)*
