...
- [AutoBow](/docs/Modules/Combat/AutoBow) — Automates many bow-related actions like aiming and shooting.
- [AutoClicker](/docs/Modules/Combat/AutoClicker) — Clicks automatically when holding down the attack button.
- [AutoDodge](/docs/Modules/Combat/AutoDodge) — Automatically dodges projectiles like arrows.
- [AutoLeave](/docs/Modules/Combat/AutoLeave) — Automatically leaves the server whenever your health goes below the certain threshold.
- [AutoPearl](/docs/Modules/Combat/AutoPearl) — Aims and throws a pearl at an enemies pearl trajectory.
- [AutoRod](/docs/Modules/Combat/AutoRod) — Automatically uses fishing rod for combat.
- [AutoShoot](/docs/Modules/Combat/AutoShoot) — Automatically throws eggs and snowballs at your targets or shoots in QuakeCraft.
- [AutoWeapon](/docs/Modules/Combat/AutoWeapon) — Automatically selects the best weapon in your hotbar.
...
- [KeepSprint](/docs/Modules/Combat/KeepSprint) — Keeps you sprinting even when attacking.
...
- [TimerRange](/docs/Modules/Combat/TimerRange) — Accelerates the game time when being within the range of an enemy.
- [TpAura](/docs/Modules/Combat/TpAura) — Automatically teleports and attacks enemies around you.
