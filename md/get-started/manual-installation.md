...
LiquidBounce Nextgen is our most recent client with active development. It is based on 26.3, but compatible with all Minecraft versions and features a modern user interface, improved performance and enhanced modules. To install it manually, follow the instructions below.
